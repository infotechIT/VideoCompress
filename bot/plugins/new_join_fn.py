    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            if user.status == "kicked":
               await message.reply_text(
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/linux_repositori).",
                   parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Support Group](https://t.me/linux_repositori).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/linux_repositori')
                ],
                [
                    InlineKeyboardButton('Developer', url='https://t.me/infotechIT'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('Source Code', url='https://github.com/infotechIT/VideoCompress') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
